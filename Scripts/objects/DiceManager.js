 ...
 * @date 2020/02/22
 * @description This class handles all the dice which are displayed in a line on a single scene.
 *              The class allows you to specify the number of dice to display
 */
var objects;
(function (objects) {
